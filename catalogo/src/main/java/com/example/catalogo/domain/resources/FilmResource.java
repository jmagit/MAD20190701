...
import com.example.catalogo.application.amqp.NotificacionesMQ;
...
public class FilmResource {
	...
	@Autowired
	private NotificacionesMQ notify;

	public Set<ConstraintViolation<Film>> validate(Film item) {
	...
	public ResponseEntity<Object> add(@Valid @RequestBody FilmEditDTO item) throws Exception {
		...
		dao.save(rslt);
		notify.sendAdd("PELICULA", rslt.getFilmId());
	...
	public FilmEditDTO change(
		...
		notify.sendModify("PELICULA", rslt.getFilmId());
